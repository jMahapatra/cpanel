...
include("../require/common.inc.php");
    ...
    $notice = htmlentities($_POST['MTXT_UpdateData'],ENT_QUOTES,'utf-8');
		mysql_query("INSERT INTO `update_detail`(`Updates`, `UploadBy`, `UploadDate`, `IsActive`) VALUES('".$notice."', '".$_POST['TXT_UploadBy']."', '".date('Y-m-d')."', '1')")or die (mysql_error());
...
<!-- /.navbar -->
                      ...
                      <div class="body">
                        <form class="form-horizontal" method="post" action="" enctype="multipart/form-data">
                            <div class="form-group">
                              <div class="col-lg-6">
                                <input type="text" class="form-control" name="TXT_EventDt" id="TXT_EventDt" placeholder="Notice publish date" required="required" oninvalid="this.setCustomValidity('Enter a publish date')"
    oninput="setCustomValidity('')" value="<?php echo date('Y-m-d')?>"/>
                              </div>
                            </div>
                            <div class="form-group">
                              <div class="col-lg-12">
                                <textarea name="MTXT_UpdateData" id="MTXT_UpdateData" placeholder="Notice content" class="form-control" required="required" oninvalid="this.setCustomValidity('Please enter notice content')"
    oninput="setCustomValidity('')"></textarea>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-lg-6">
                                <input type="reset" name="BTN_Reset_Event" id="BTN_Reset_Event" value="Cancel" class="btn btn-block btn-warning" />
                              </div>
                            </div>
