...
if(isset($_POST['BTN_UplData']))
{
  ...
  if($browsefile!='')
  {
    $res_DocID=mysql_query("SELECT * FROM `upl_document` ORDER BY `DocumentID` DESC"); 
    $row_DocID=mysql_fetch_array($res_DocID);
    if(mysql_num_rows($res_DocID)==0)
    {
      $document_ID=1;	
    }
    else
    {
      $document_ID=$row_DocID['DocumentID']+1;	
    }
    
    $exten= pathinfo($browsefile, PATHINFO_EXTENSION);
    $filename = "DocumentNo_".$document_ID.".".$exten;

    move_uploaded_file($_FILES['FF_File']['tmp_name'], "../../Document/".$filename);

    mysql_query("INSERT INTO `upl_document`(`FileFor`, `Subject`, `Description`, `FileName`, `UplDate`, `IsBlock`) VALUES('".$_POST['SE_FileFor']."', '".$_POST['TXT_DocSubject']."', '".$_POST['MTXT_Desc']."', '".$filename."', '".date('Y-m-d')."', '1')");
  }
}
...
<body>
  ...
  <div id="content">
          ...
          <div class="col-lg-6">
            <div class="box">
              ...
              <div class="body">
                  ...
                  <div class="form-group">
                    <div class="col-lg-12">
                      <select name="SE_FileFor" id="SE_FileFor" class="form-control" required="required">
                        ...
                        <option value="Examination Form">Examination Forms</option>
                ...
                <div class="form-group">
                  <div class="col-lg-12">
                    <input type="text" name="TXT_DocSubject" id="TXT_DocSubject" class="form-control" placeholder="Document Title" required="required" oninvalid="this.setCustomValidity('Please Enter Document Title')"
    oninput="setCustomValidity('')"/>
                  </div>
                </div>
                <div class="form-group">
                  <div class="col-lg-12">
                    <textarea name="MTXT_Desc" class="form-control" id="MTXT_Desc" rows="4" placeholder="Description (optional)" ></textarea>
                  </div>
                </div>
                <div class="form-group">
                  <div class="col-md-12">
    ...
    <div class="col-lg-6">
      <div class="box">
        <header class="dark">
          <div class="icons"><i class="fa fa-files-o fa-2x"></i></div>
