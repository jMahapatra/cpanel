...
$row_eventDesc = mysql_fetch_array(mysql_query("SELECT * FROM `menu_contents_detail` WHERE `LE_C_Slno` = '".$_GET['contid']."'"));
	...
	if(isset($_POST['BTN_UpdEventData']))
	{
      ...
      header("location:UploadMenuDescription.php?menuNm=".$_GET['menuNm']);
		}
?>
...
<!-- /.navbar -->
                ...
                <!-- ."main-bar -->
                    <div class="main-bar">
                        <h3><i class="fa fa-edit"></i> Edit Menu Content</h3>
                  </div>
                    <!-- /.main-bar -->
            </header>
                <!-- end header.head -->
    ...
    Image</label>
                            ...
                            <?php 
							  if($row_eventDesc['LE_C_Type']=="Image")
                              { 
                              $img_dir="../../Upl_Images/TextContent/";
                              $imageLocation = ($row_eventDesc['LE_C_Content']!='')? $img_dir.trim($row_eventDesc['LE_C_Content']) : 'http://www.placehold.it/200x150/EFEFEF/AAAAAA&amp;text=no+image';
                              ?>
                              <div class="body">
                              ...
                              ?>
                                ...
                                <div class="col-lg-8">
                                  ...
                                  <div class="fileupload fileupload-new" data-provides="fileupload">
                                    <div class="fileupload-new thumbnail img-responsive" style="width: 400px; height: 300px;"><img src="<?php echo $imageLocation?>" alt="" /></div>
                                    <div class="fileupload-preview fileupload-exists thumbnail" style="max-width: 400; max-height: 300px; line-height: 20px;"></div>
                            ...
                            <div class="form-group"> 
                              ...
                              <div class="col-md-3">
                                <input type="submit" name="BTN_UpdEventData" id="BTN_UpdEventData" value="Save" class="btn btn-primary btn-block" />
                              </div>
                              <div class="col-md-3">
